...
public class RouteController {
  ...
  public ResponseEntity<String> retrieveDepartment(@RequestParam(value = "deptCode") String deptCode) {
    try {
      ...
      if (departmentMapping.containsKey(deptCode)) {
        return new ResponseEntity<>(departmentMapping.get(deptCode).toString(), HttpStatus.OK);
      }
  ...
  public ResponseEntity<String> retrieveCourse(@RequestParam(value = "deptCode") String deptCode,
  ...
  public ResponseEntity<String> isCourseFull(@RequestParam(value = "deptCode") String deptCode,
                                        @RequestParam(value = "courseCode") int courseCode) {
    try {
      deptCode = deptCode.toUpperCase();

      ResponseEntity<String> retrieveCourseResponse =  retrieveCourse(deptCode, courseCode);
      ...
      if (doesCourseExists) {
        ...
        return new ResponseEntity<>(String.valueOf(requestedCourse.isCourseFull()), HttpStatus.OK);
      }
      return new ResponseEntity<>(retrieveCourseResponse.getBody(), retrieveCourseResponse.getStatusCode());
    } catch (Exception e) {
      return handleException(e);
    }
  }
  ...
  public ResponseEntity<String> getMajorCtFromDept(@RequestParam(value = "deptCode") String deptCode) {
    try {
      deptCode = deptCode.toUpperCase();
  ...
  public ResponseEntity<String> identifyDeptChair(@RequestParam(value = "deptCode") String deptCode) {
    try {
      deptCode = deptCode.toUpperCase();
  ...
  public ResponseEntity<String> findCourseLocation(@RequestParam(value = "deptCode") String deptCode,
                                              @RequestParam(value = "courseCode") int courseCode) {
    try {
      deptCode = deptCode.toUpperCase();
  ...
  public ResponseEntity<String> findCourseInstructor(@RequestParam(value = "deptCode")
                                                String deptCode,
  ...
  public ResponseEntity<String> findCourseTime(@RequestParam(value = "deptCode") String deptCode,
                                          @RequestParam(value = "courseCode") int courseCode) {
    try {
      deptCode = deptCode.toUpperCase();
  ...
  public ResponseEntity<String> addMajorToDept(@RequestParam(value = "deptCode") String deptCode) {
    try {
      deptCode = deptCode.toUpperCase();
      ...
      if (doesDepartmentExists) {
        ...
        return new ResponseEntity<>("Attribute was updated or is at maximum", HttpStatus.OK);
      }
      return new ResponseEntity<>("Department Not Found", HttpStatus.NOT_FOUND);
    } catch (Exception e) {
      return handleException(e);
  ...
  public ResponseEntity<String> removeMajorFromDept(@RequestParam(value = "deptCode") String deptCode) {
    try {
      deptCode = deptCode.toUpperCase();
  ...
  public ResponseEntity<String> dropStudent(@RequestParam(value = "deptCode") String deptCode,
                                       @RequestParam(value = "courseCode") int courseCode) {
    try {
      deptCode = deptCode.toUpperCase();
  ...
  public ResponseEntity<String> setEnrollmentCount(@RequestParam(value = "deptCode") String deptCode,
                                              @RequestParam(value = "courseCode") int courseCode,
    ...
    try {
      ...
      if (doesCourseExists) {
        ...
        if(requestedCourse.getEnrollmentCapacity() > count) {
          return new ResponseEntity<>("Attributed was not updated.", HttpStatus.BAD_REQUEST);
        }
  ...
  public ResponseEntity<String> changeCourseTime(@RequestParam(value = "deptCode") String deptCode,
                                            @RequestParam(value = "courseCode") int courseCode,
  ...
  public ResponseEntity<String> changeCourseTeacher(@RequestParam(value = "deptCode") String deptCode,
                                               @RequestParam(value = "courseCode") int courseCode,
  ...
  public ResponseEntity<String> changeCourseLocation(@RequestParam(value = "deptCode") String deptCode,
                                                @RequestParam(value = "courseCode") int courseCode,
